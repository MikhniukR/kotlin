            ...
            reportSourceSetCommonizerDependencies(this) {
                ...
                if (isWindows) {
                    getCommonizerDependencies("windowsMain").onlyCInterops().apply {
                        assertDependencyFilesMatches(".*nativeHelper", ".*unixHelper", ".*windowsHelper")
                    ...
                    getCommonizerDependencies("windowsTest").onlyCInterops().apply {
                        assertDependencyFilesMatches(".*nativeHelper", ".*unixHelper", ".*windowsHelper", ".*nativeTestHelper")
                        assertTargetOnAllDependencies(CommonizerTarget(MINGW_X86, MINGW_X64))
                    }

                    getCommonizerDependencies("windowsX64").assertEmpty()
                    getCommonizerDependencies("windowsX86").assertEmpty()
                }
            }
